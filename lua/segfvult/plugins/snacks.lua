return {
  ...
  keys = {
    ...
    { "<leader>ef",  function() Snacks.explorer.reveal() end,  desc = "Reveal Explorer" },
    ...
    { "<leader>fbs", function() Snacks.picker.lines() end,     desc = "Find Buffers Fuzzy" },
    { "<leader>fgs", function() Snacks.picker.grep_word() end, desc = "Find Grep String" },
