...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(ev)
    ...
    vim.keymap.set("n", "<Leader>lD", function() Snacks.picker.lsp_declarations() end, opts)
    ...
    vim.keymap.set("n", "<Leader>lh", function() vim.lsp.buf.hover({ border = border_style }) end, opts)
    vim.keymap.set("n", "<Leader>lS", function() vim.lsp.buf.signature_help({ border = border_style }) end, opts)
    ...
    vim.keymap.set({ "n", "v" }, "<Leader>f", function() require("conform").format({ bufnr = ev.buf }) end, opts)
